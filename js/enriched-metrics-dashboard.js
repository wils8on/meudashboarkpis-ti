...
function renderDimension(dimension) {
    ...
    document.querySelectorAll('[data-operational-dimension]').forEach(button => { const selected = button.dataset.operationalDimension === dimension; button.classList.toggle('is-active', selected); button.setAttribute('aria-selected', String(selected)); });
